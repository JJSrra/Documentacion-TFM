...
%\vspace{0.7cm}
\noindent{\textbf{Palabras clave}: sistema de recomendación, socioinspirado, social, grupos, técnica, comparativa, análisis experimental}\\
...
%\vspace{0.7cm}
\noindent{\textbf{Keywords}: recommender system, socioinspired, social, groups, technique, comparative analysis, experimental analysis}\\
